...
import { calcularPenalizacion, Evento, guardarViaje } from '../../utils/viajes';
...
export default function Conducir() {
  ...
  const [perfil, setPerfil] = useState<{nombre: string, vehiculo: string, ciudad: string} | null>(null);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        {perfil && <Text style={styles.infoText}>{perfil.nombre} · {perfil.vehiculo}</Text>}
